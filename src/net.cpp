...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Blingcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"blingcointools.com", "dnsseed.blingcointools.com"},
    {"blingcoinpool.org", "dnsseed.blingcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"blingcointools.com", "testnet-seed.blingcointools.com"},
